...
namespace FFmpegSharp.Executor
{
    ...
    {
        public static string FFmpeg(string @params, Action<int> onStart = null)
        {
            return Execute(true, @params, onStart);
        }

        public static string FFprobe(string @params, bool is_push, Action<int> onStart = null)
        {
        ...
        private static string Execute(bool userFFmpeg, string @params, Action<int> onStart = null)
        {
            ...
            try
            {
                using (p = new Process())
                {
                    ...
                    XTrace.WriteLine($"{exePath} {@params}");
